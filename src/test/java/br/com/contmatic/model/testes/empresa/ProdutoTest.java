...
import static br.com.contmatic.model.constantes.auditoria.AuditoriaTestConstantes.IP_ALTERACAO_DEFAULT;
import static br.com.contmatic.model.constantes.auditoria.AuditoriaTestConstantes.IP_CRIACAO_DEFAULT;
import static br.com.contmatic.model.constantes.auditoria.AuditoriaTestConstantes.USUARIO_ALTERACAO_DEFAULT;
import static br.com.contmatic.model.constantes.auditoria.AuditoriaTestConstantes.USUARIO_CRIACAO_DEFAULT;
...
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.DATA_ATUAL;
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.DATA_INICIO_ANO;
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.ESPACO_BRANCO;
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.FLOAT_99999999;
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.FLOAT_NEGATIVA_1;
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.INT_99999999;
import static br.com.contmatic.model.constantes.comuns.ConstantesComuns.INT_NEGATIVA_1;
...
import static br.com.contmatic.model.constantes.empresa.ProdutoTestConstantes.CODIGO_BARRA_TESTES;
import static br.com.contmatic.model.constantes.empresa.ProdutoTestConstantes.DESCRICAO_DEFAULT;
import static br.com.contmatic.model.constantes.empresa.ProdutoTestConstantes.PRECO_DEFAULT;
import static br.com.contmatic.model.constantes.empresa.ProdutoTestConstantes.QUANTIDADE_DEFAULT;
...
public class ProdutoTest {
    ...
    public void teste_08_nao_deve_ultrapassar_tamanho_max_preco() {
        this.produto.setPreco(FLOAT_99999999);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_09_nao_deve_limiar_tamanho_min_preco() {
        this.produto.setPreco(FLOAT_NEGATIVA_1);
    }
