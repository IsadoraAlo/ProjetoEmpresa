...
public class FuncionarioTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_55_nao_deve_aceitar_data_aposentadoria_nulo() {
        this.funcionario.setDataNascimento(DATA_NASCIMENTO_DEFAULT);
        this.funcionario.setDataContratacao(DATA_CONTRATACAO_DEFAULT);
        this.funcionario.setDataDemissao(DATA_DEMISSAO_DEFAULT);
    ...
    @Test(expected = IllegalStateException.class)
    public void teste_56_nao_deve_aceitar_data_aposentadoria_muito_futura() {
        this.funcionario.setDataNascimento(DATA_NASCIMENTO_DEFAULT);
        this.funcionario.setDataContratacao(DATA_CONTRATACAO_DEFAULT);
    ...
    @Test(expected = IllegalStateException.class)
    public void teste_57_nao_deve_aceitar_data_aposentadoria_ultrapassada() {
        this.funcionario.setDataNascimento(DATA_NASCIMENTO_DEFAULT);
        this.funcionario.setDataContratacao(DATA_CONTRATACAO_DEFAULT);
    ...
    @Test(expected = IllegalStateException.class)
    public void teste_58_nao_deve_validar_data_aposentadoria_menor_data_contratacao() {
        this.funcionario.setDataNascimento(DATA_NASCIMENTO_DEFAULT);
    ...
    @Test
    public void teste_59_deve_validar_data_aposentadoria_com_sucesso() {
        this.funcionario.setDataNascimento(DATA_NASCIMENTO_DEFAULT);
        this.funcionario.setDataContratacao(DATA_CONTRATACAO_DEFAULT);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_60_nao_deve_aceitar_cpf_nulo() {
        this.funcionario.setCpf(null);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_61_nao_deve_aceitar_cpf_em_branco() {
        this.funcionario.setCpf(ESPACO_BRANCO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_62_nao_deve_ultrapassar_qntd_caractere_max_cpf() {
        this.funcionario.setCpf(STRING_NUMERICA_20);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_63_nao_deve_limiar_qntd_caractere_min_cpf() {
        this.funcionario.setCpf(STRING_NUMERICA_1);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_64_nao_deve_aceitar_caracteres_invalidos_cpf() {
        this.funcionario.setCpf(STRING_CARACTERES_ESPECIAIS_10);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_65_nao_deve_aceitar_repeticoes_0_cpf() {
        this.funcionario.setCpf("00000000000");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_66_nao_deve_aceitar_repeticoes_1_cpf() {
        this.funcionario.setCpf("11111111111");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_67_nao_deve_aceitar_repeticoes_2_cpf() {
        this.funcionario.setCpf("22222222222");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_68_nao_deve_aceitar_repeticoes_3_cpf() {
        this.funcionario.setCpf("33333333333");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_69_nao_deve_aceitar_repeticoes_4_cpf() {
        this.funcionario.setCpf("44444444444");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_70_nao_deve_aceitar_repeticoes_5_cpf() {
        this.funcionario.setCpf("55555555555");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_71_nao_deve_aceitar_repeticoes_6_cpf() {
        this.funcionario.setCpf("66666666666");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_72_nao_deve_aceitar_repeticoes_7_cpf() {
        this.funcionario.setCpf("77777777777");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_73_nao_deve_aceitar_repeticoes_8_cpf() {
        this.funcionario.setCpf("88888888888");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_74_nao_deve_aceitar_repeticoes_9_cpf() {
        this.funcionario.setCpf("99999999999");
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_75_nao_deve_aceitar_cpf_invalido() {
        this.funcionario.setCpf("92929499011");
    }
    
    @Test
    public void teste_76_deve_validar_cpf_com_sucesso() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_77_nao_deve_aceitar_usuario_criacao_nulo() {
        this.funcionario.setUsuarioCriacao(null);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_78_nao_deve_aceitar_usuario_criacao_em_branco() {
        this.funcionario.setUsuarioCriacao(ESPACO_BRANCO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_79_nao_deve_ultrapassar_qntd_caractere_max_usuario_criacao() {
        this.funcionario.setUsuarioCriacao(STRING_ALFABETICA_75);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_80_nao_deve_limiar_qntd_caractere_min_usuario_criacao() {
        this.funcionario.setUsuarioCriacao(STRING_ALFABETICA_1);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_81_nao_deve_aceitar_caracteres_usuario_criacao() {
        this.funcionario.setUsuarioCriacao(STRING_CARACTERES_ESPECIAIS_10);
    }
    
    @Test
    public void teste_82_deve_validar_usuario_criacao_com_sucesso() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_83_nao_deve_aceitar_usuario_alteracao_nulo() {
        this.funcionario.setUsuarioAlteracao(null);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_84_nao_deve_aceitar_usuario_alteracao_em_branco() {
        this.funcionario.setUsuarioAlteracao(ESPACO_BRANCO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_85_nao_deve_ultrapassar_qntd_caractere_max_usuario_alteracao() {
        this.funcionario.setUsuarioAlteracao(STRING_ALFABETICA_75);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_86_nao_deve_limiar_qntd_caractere_min_usuario_alteracao() {
        this.funcionario.setUsuarioAlteracao(STRING_ALFABETICA_1);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_87_nao_deve_aceitar_caracteres_usuario_alteracao() {
        this.funcionario.setUsuarioAlteracao(STRING_CARACTERES_ESPECIAIS_10);
    }
    
    @Test
    public void teste_88_deve_validar_usuario_alteracao_com_sucesso() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_89_nao_deve_aceitar_ip_criacao_nulo() {
        this.funcionario.setIpCriacao(null);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_90_nao_deve_aceitar_ip_criacao_em_branco() {
        this.funcionario.setIpCriacao(ESPACO_BRANCO);
    }

    @Test(expected = IllegalStateException.class)
    public void teste_91_nao_deve_ultrapassar_qntd_caractere_max_ip_criacao() {
        this.funcionario.setIpCriacao(STRING_ALFABETICA_75);
    }    
   
    @Test(expected = IllegalStateException.class)
    public void teste_92_nao_deve_limiar_qntd_caractere_min_ip_criacao() {
        this.funcionario.setIpCriacao(STRING_ALFABETICA_1);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_93_nao_deve_aceitar_caracteres_ip_criacao() {
        this.funcionario.setIpCriacao(STRING_CARACTERES_ESPECIAIS_10);
    }
    
    @Test
    public void teste_94_deve_validar_ip_criacao_com_sucesso() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_95_nao_deve_aceitar_ip_alteracao_nulo() {
        this.funcionario.setIpAlteracao(null);
    }  
    
    @Test(expected = IllegalStateException.class)
    public void teste_96_nao_deve_aceitar_ip_alteracao_em_branco() {
        this.funcionario.setIpAlteracao(ESPACO_BRANCO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_97_nao_deve_ultrapassar_qntd_caractere_max_ip_alteracao() {
        this.funcionario.setIpAlteracao(STRING_ALFABETICA_75);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_98_nao_deve_limiar_qntd_caractere_min_ip_alteracao() {
        this.funcionario.setIpAlteracao(STRING_ALFABETICA_1);
    }   
    
    @Test(expected = IllegalStateException.class)
    public void teste_99_nao_deve_aceitar_caracteres_ip_alteracao() {
        this.funcionario.setIpAlteracao(STRING_CARACTERES_ESPECIAIS_10);
    }
    
    @Test
    public void teste_100_deve_validar_ip_alteracao_com_sucesso() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_101_nao_deve_aceitar_data_criacao_nulo() {
        this.funcionario.setDataCriacao(null);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_102_nao_deve_aceitar_data_criacao_muito_futura() {
        this.funcionario.setDataCriacao(DATA_300_ANOS_FUTURO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_103_nao_deve_aceitar_data_criacao_ultrapassada() {
        this.funcionario.setDataCriacao(DATA_100_ANOS_PASSADO);
    }
    
    @Test
    public void teste_104_deve_validar_data_criacao_com_sucesso() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void teste_105_nao_deve_aceitar_data_alteracao_nulo() {
        this.funcionario.setDataCriacao(DATA_INICIO_ANO);
        this.funcionario.setDataAlteracao(null);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_106_nao_deve_aceitar_data_alteracao_muito_futura() {
        this.funcionario.setDataCriacao(DATA_INICIO_ANO);
        this.funcionario.setDataAlteracao(DATA_300_ANOS_FUTURO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_107_nao_deve_aceitar_data_alteracao_ultrapassada() {
        this.funcionario.setDataCriacao(DATA_INICIO_ANO);
        this.funcionario.setDataAlteracao(DATA_100_ANOS_PASSADO);
    }
    
    @Test(expected = IllegalStateException.class)
    public void teste_108_nao_deve_validar_data_alteracao_menor_data_criacao() {
        this.funcionario.setDataCriacao(DATA_ATUAL);
        this.funcionario.setDataAlteracao(DATA_INICIO_ANO);
    }
    
    @Test
    public void teste_109_deve_validar_data_alteracao_com_sucesso() {
        this.funcionario.setDataCriacao(DATA_INICIO_ANO);
...
// TO STRING
    ...
    @Test
    public void teste_110_deve_validar_to_string() {
        this.funcionario.setEndereco(this.endereco);
    ...
    @Test
    public void teste_111_deve_validar_hash_code_equivalentes() {
        assertEquals(this.funcionario.hashCode(), this.funcionario.hashCode());
    }
    
    @Test
    public void teste_112_deve_validar_hash_code_divergentes() {
    ...
    @Test
    public void teste_113_deve_validar_equals_com_campos_equivalentes() {
        assertTrue(this.funcionario.equals(this.funcionario));
    }

    @Test
    public void teste_114_nao_deve_validar_equals_com_campos_divergentes() {
        assertFalse(this.funcionario.equals(this.funcionarioTestes));
    }

    @Test
    public void teste_115_nao_deve_validar_equals_nulo() {
        assertFalse(this.funcionario.equals(null));
    }

    @Test
    public void teste_116_nao_deve_validar_equals_com_classes_divergentes() {
