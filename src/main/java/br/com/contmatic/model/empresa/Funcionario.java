...
public class Funcionario extends Auditoria {
	...
	public Funcionario(String cpf, String nomeCompleto, LocalDate dataNascimento, String sexo) {
		setCpf(cpf);
	...
	public void setDataNascimento(LocalDate dataNascimento) {
		...
		validarDataMin(dataNascimento, TAMANHO_DATA_NASCIMENTO_MIN);
		validarDataMax(dataNascimento, TAMANHO_DATA_NASCIMENTO_MAX);
	...
	public void setDataDemissao(LocalDate dataDemissao) {
		...
		validarDataMin(dataDemissao, TAMANHO_DATA_DEMISSAO_MIN);
		validarDataMax(dataDemissao, TAMANHO_DATA_DEMISSAO_MAX);
		validarDataFinalMenorInicial(dataDemissao, this.dataContratacao,
				MSG_DATA_DEMISSAO_MENOR_CONTRATACAO);
	...
	public void setDataAposentadoria(LocalDate dataAposentadoria) {
		...
		validarNulo(this.dataContratacao, MSG_DATA_CONTRATACAO_DATA_DEMISSAO_NULO);
	    validarDataMin(dataAposentadoria, TAMANHO_DATA_DEMISSAO_MIN);
	    validarDataMax(dataAposentadoria, TAMANHO_DATA_DEMISSAO_MAX);
