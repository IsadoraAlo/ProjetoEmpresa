...
public class Empresa extends Auditoria {
	...
	public Empresa(String cnpj, String nomeFantasia, String razaoSocial, Contato contato, List<Endereco> enderecos,
			List<Funcionario> funcionarios, List<Produto> produtos) {
		setCnpj(cnpj);
		setNomeFantasia(nomeFantasia);
		setRazaoSocial(razaoSocial);	
		setContato(contato);
	...
	public void setNomeFantasia(String nomeFantasia) {
		...
		validarQuantidadeCaracteresString(nomeFantasia, TAMANHO_NOME_FANTASIA_MAX, TAMANHO_NOME_FANTASIA_MIN,
				MSG_NOME_FANTASIA_QTDE_CARACTERES);
	...
	public void setRazaoSocial(String razaoSocial) {
		...
		validarQuantidadeCaracteresString(razaoSocial, TAMANHO_RAZAO_SOCIAL_MAX, TAMANHO_RAZAO_SOCIAL_MIN,
				MSG_RAZAO_SOCIAL_QTDE_CARACTERES);
	...
	public void setEndereco(List<Endereco> enderecos) {
		...
		validarQuantidadeElementoLista(enderecos, TAMANHO_ENDERECO_LISTA_MAX, TAMANHO_ENDERECO_LISTA_MIN,
				MSG_ENDERECO_LISTA_EXCEDIDA);
	...
	public void setFuncionario(List<Funcionario> funcionarios) {
		...
		validarQuantidadeElementoLista(funcionarios, TAMANHO_FUNCIONARIO_LISTA_MAX, TAMANHO_FUNCIONARIO_LISTA_MIN,
				MSG_FUNCIONARIO_LISTA_EXCEDIDA);
	...
	public void setProduto(List<Produto> produtos) {
		...
		validarQuantidadeElementoLista(produtos, TAMANHO_PRODUTO_LISTA_MAX, TAMANHO_PRODUTO_LISTA_MIN,
				MSG_PRODUTO_LISTA_EXCEDIDA);
